...
namespace UnityEngine.Experimental.Input
{
    public static class ControlMappingExtensions
    {
        ...
        public static void HatMapping(this ControlSetup setup, int sourceIndex, SupportedControl left, SupportedControl right, SupportedControl down, SupportedControl up)
        {
    ...
    public class ControlHatMapping : IControlMapping
    {
        ...
        public ControlHatMapping(int targetIndexLeft, int targetIndexRight, int targetIndexDown, int targetIndexUp)
        {
        ...
        public bool Remap(GenericControlEvent controlEvent)
        {
            ...
            switch (floatEvent.rawValue)
            {
                case 1: up.value = 1.0f; break;
                case 2: up.value = 1.0f; right.value = 1.0f; break;
                case 3: right.value = 1.0f; break;
                case 4: right.value = 1.0f; down.value = 1.0f; break;
                case 5: down.value = 1.0f; break;
                case 6: down.value = 1.0f; left.value = 1.0f; break;
                case 7: left.value = 1.0f; break;
                case 8: left.value = 1.0f; up.value = 1.0f; break;
            }
