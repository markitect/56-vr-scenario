...
namespace UnityEngine.Experimental.Input
{
    ...
    public class Pointer : InputDevice
    {
        ...
        public AxisControl positionX { get { return (AxisControl)GetControl((int)PointerControl.PositionX); } }
        public AxisControl positionY { get { return (AxisControl)GetControl((int)PointerControl.PositionY); } }
        public AxisControl positionZ { get { return (AxisControl)GetControl((int)PointerControl.PositionZ); } }

        public AxisControl deltaX { get { return (AxisControl)GetControl((int)PointerControl.DeltaX); } }
        public AxisControl deltaY { get { return (AxisControl)GetControl((int)PointerControl.DeltaY); } }
        public AxisControl deltaZ { get { return (AxisControl)GetControl((int)PointerControl.DeltaZ); } }

        public ButtonControl leftButton { get { return (ButtonControl)GetControl((int)PointerControl.LeftButton); } }
        public ButtonControl rightButton { get { return (ButtonControl)GetControl((int)PointerControl.RightButton); } }

        ////REVIEW: why do these return values instead of controls?
        public Vector3 position
        {
            get { return ((Vector3Control)GetControl((int)PointerControl.Position)).value; }
        }

        public float pressure
        {
            get { return ((AxisControl)GetControl((int)PointerControl.Pressure)).value; }
        }
